        ...
        <div className='w-[100vw] h-[100vh] bg-indigo-700 flex items-center'>
            <div className="w-full max-w-md p-4 rounded-md shadow-2xl sm:p-8 mx-auto bg-white">
                ...
                <div className="my-6 space-y-4">
                    <button onClick="" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-violet-400 hover:bg-green-200">
